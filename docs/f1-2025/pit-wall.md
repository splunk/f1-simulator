...
- It works identically with [Playback Mode](controller-config.md#playback-mode), which makes it a good way to test a booth display before an event.
- Speed follows the **Speed Display** setting under [Config → General](controller-config.md#general).
