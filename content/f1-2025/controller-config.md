...
**Blank token fields keep the stored token**
...
2. Select your {{< term "realm" >}} from the list, for example `us0` or `eu0`.
...
Sends flattened events through HTTP Event Collector ({{< term "HEC" >}}).
