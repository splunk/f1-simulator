...
The collector separates {{< term "UDP" >}} ingest from destination delivery. A healthy game connection does not prove {{< term "HEC" >}} or Observability is healthy, so check both sides.
...
{{< details title="Log storage and forwarding" closed="true" >}}
...
{{< details title="Why the public-address badge may be missing" closed="true" >}}
